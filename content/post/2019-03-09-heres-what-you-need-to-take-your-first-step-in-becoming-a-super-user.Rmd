...
I haven't even begun to look at more specific shortcuts like [Gmail shortcuts that can save you hours](https://blog.hubspot.com/sales/gmail-keyboard-shortcuts) or [creating a shortcut on Macs to eliminate right clicking](https://beebom.com/how-right-click-using-keyboard-mac/), but I hope this has given you a taste of the awesomeness you could embody while whizzing around your laptop, impressing your work colleagues with 150% increases in productivity and time-saving skills.

Again, I want to stress that keyboard shortcuts tend to carry across applications (and operating systems), so each one you learn can have multiple benefits. There are so many more out there that I haven't mentioned, so start Googling (or better [DuckDuckGo-ing](https://duckduckgo.com)) as many shortcuts that will fit in your brain and you will be well on your way to becoming a Super User ninja.
